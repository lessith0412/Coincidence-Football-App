...
import '../ManchesterUnited/models/product.dart';
import '../ManchesterUnited/screens/product/products_screen.dart';
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('Cards/CC/ManUnited/manunited.jpg'),
              fit: BoxFit.cover,
            )
        ),
        child: Center(
